...
exports.NonReplacementWeightedSampler = exports.DEFAULT_FAILED_SAMPLE_ATTEMPTS_BEFORE_RESTRUCTURE = void 0;
exports.DEFAULT_FAILED_SAMPLE_ATTEMPTS_BEFORE_RESTRUCTURE = 2;
/**
 ...
 *    assessments.
 */
class NonReplacementWeightedSampler {
    /**
     * Constructor
     *
    ...
    constructor(items, respectiveWeights, failedSampleAttemptsBeforeRestructure = exports.DEFAULT_FAILED_SAMPLE_ATTEMPTS_BEFORE_RESTRUCTURE) {
        ...
        this._restructureAttemptsCounter = 0;
        if (items.length === 0) {
        ...
        if (!isNaturalNumber(failedSampleAttemptsBeforeRestructure)) {
            throw new Error(`Received a non-natural failedSampleAttemptsBeforeRestructure argument of ` +
                `${failedSampleAttemptsBeforeRestructure}`);
        }
        if (items.includes(undefined)) {
            throw new Error("Items cannot contain undefined values");
        }
        const nonPositiveWeight = respectiveWeights.find(weight => weight <= 0);
...
exports.NonReplacementWeightedSampler = NonReplacementWeightedSampler;
function isNaturalNumber(num) {
    const floored = Math.floor(num);
    return floored >= 1 && floored === num;
}
//# sourceMappingURL=non-replacement-weighted-sampler.js.map